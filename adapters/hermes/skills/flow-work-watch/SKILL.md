---
name: flow-work-watch
description: "Monitor the observability platform after a deploy and alert on errors or performance regressions (autopiloted)"
---

<!-- GENERATED by script/adapter-build.py from plugins/flow/commands/work/watch.md — do not edit; change the plugin file and run the script. -->
