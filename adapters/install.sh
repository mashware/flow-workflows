...
case "$TOOL" in
  opencode)
    ...
    echo "✓ opencode: 24 commands in $DEST  (invoke as /feat-start, /work-watch, …)"
  ...
  gemini)
    ...
    echo "✓ gemini: 24 commands in $DEST  (invoke as /feat:start, /work:watch, …)"
  ...
  codex)
    ...
    echo "✓ codex: 24 prompts in $DEST  (invoke as /feat-start, /work-watch, …)"
