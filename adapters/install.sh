...
case "$TOOL" in
  opencode)
    ...
    echo "✓ opencode: 22 commands in $DEST  (invoke as /feat-start, /work-watch, …)"
  ...
  gemini)
    ...
    echo "✓ gemini: 22 commands in $DEST  (invoke as /feat:start, /work:watch, …)"
  ...
  codex)
    ...
    echo "✓ codex: 22 prompts in $DEST  (invoke as /feat-start, /work-watch, …)"
