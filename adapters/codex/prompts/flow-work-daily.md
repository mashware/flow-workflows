...
- **Unresolved review threads** on your MRs/PRs → flag it (links to `/flow-work-respond`).
...
- Local work whose branch has an open MR/PR with **CI red** → `/flow-work-green`; with **unresolved threads** → `/flow-work-respond`.
...
Blockers / attention
  <CI red · reviews awaiting you · divergences · raised priorities — or "none">
