...
- If **either** threshold is exceeded: add `⚠ exceeds estimate` and suggest that `/flow-feat-build` applies §2.3 (the size gauge: cut / continue / reopen).
