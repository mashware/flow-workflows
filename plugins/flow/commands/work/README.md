...
5. **A knowledge store is optional but recommended** when closing large features or postmortems (`knowledge.search` at least; `save` for a real store, else `KNOWLEDGE.md`).
