...
- **Open follow-ups**: `followups[]` entries not `declined`/`done`, from the live works **and** from `_archive/*/meta.json` (flow-core §7). The archive is read for this and nothing else.
