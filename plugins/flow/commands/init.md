...
<!-- stack-detection:start — the one place in this plugin that may name an
     ecosystem's tools. Recognising eleven stacks is not depending on one;
     outside these markers a tool name belongs in a FLOW.md key. -->
