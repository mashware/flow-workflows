...
Design the technical solution for the work on this branch before any code is written. The work is `DEMO-203`, its folder is `.claude/work/DEMO-203/`, and the ticket is in its `01-context.md`. Stop when the design is done: do not plan, build or run any later phase.
